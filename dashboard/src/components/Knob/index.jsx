...
import "./index.css";
class KnobWithoutText extends React.Component {
  constructor(props) {
    super(props);
...
const Knob = ({ text = "", ...knobProps }) => {
  return (
    <div>
      <KnobWithoutText {...knobProps} degrees={260} size={100} />
      <div className="mt-8 ml-3 font-medium text-white">{text}</div>
    </div>
  );
};
export default Knob;
